...
def construct_dataset(h5path:list, dataset_name: str, clip_length: int, n_video: int=-1, n_frame: int=-1, chunk_size: int = 50):
    '''
...
if __name__ == '__main__':
    ...
    clip_length = 8
    h5path = ['/mnt/sdc/wangx/HOI4D/HOI4D_dataset/seg_data_h5/train1_float32.h5',
    ...
    dataset_name = f'/mnt/sdc/wangx/HexFormer/dataset/hoi4d/frame{clip_length}_full'
    # h5float64to32(h5_dir, 100) NOTE run only if you need to save memory
    construct_dataset(h5path, dataset_name, clip_length)
